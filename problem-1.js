...
const object1 = {
    ...
    array1:['arju','kabul','johir'],
    funtionPro: function(){
    const fullSentece = this.person1.name+' and '+this.array1[0]+' solved '+this.name;
    return fullSentece
    },
    function2:(monye1,monye2)=>{
     const tot= monye1-monye2
     return tot;
    },
}

console.log(object1.funtionPro());
...
// //
const variable1 = `${object1.person1.name} got ${object1.function2(1000,200)} taka`;
console.log('practise-2 ...',variable1)
